...
from Controladores.validacion_eliminar_clientes import ValidarEliminarClientes

class InterfazEliminarClientes:
    def __init__(self, menu):
        ...
        self.controladores = ValidarEliminarClientes(self)
        self.crear_interfaz()
    ...
    def crear_interfaz(self):
        ...
        self.btnEliminar = tk.Button(self.ventana, text="Eliminar", command=self.controladores.validar_campos_y_eliminar)
        self.btnEliminar.grid(row=11, column=0, columnspan=2)